...
function Modal(props: Readonly<ModalProps>) {
    ...
    return (
        <div
            ...
            <div className="w-screen h-screen fixed top-0 left-0 bg-primary opacity-70 z-40 flex items-center justify-center"></div>
            <div className="bg-white rounded-lg shadow-lg p-6 w-96 flex flex-col items-center z-50">
                <ModalIcon type={type} />
                ...
                <div className="flex justify-end space-x-2 mt-4">
                    {buttonText1 && (
                        <button
                            className={`px-4 py-2 rounded-2xl min-w-24 ${buttonType1 === 'primary' ? 'bg-error text-white' : 'bg-gray-300 text-black'
                                }`}
                            onClick={onConfirm}>
                            {buttonText1}
                        </button>
